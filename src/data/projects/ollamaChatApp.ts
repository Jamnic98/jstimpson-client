...
const ollamaChatAppProjectId = 'ollama-chat-app'

const ollamaChatApp: Project = {
  id: ollamaChatAppProjectId,
  ...
  projectPageURI: `/coding/${ollamaChatAppProjectId}`,
  screenshotURIs: [
  ...
  links: [
    {
      label: 'GitHub Repo',
      URL: `https://github.com/Jamnic98/${ollamaChatAppProjectId}`,

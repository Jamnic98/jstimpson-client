        ...
        <article>
          <section>
            <p>
              ...
              Strava&apos;s API to pull my activity data and store it in a MongoDB database. When
              this page loads, the database is queried and the retrieved data is plotted.
            </p>
            <p>
              Since 2020, I have developed a regular running routine, aspiring to one day complete
              an ultramarathon (&#8805;50km). On the 22nd of October 2023, I ran the Battersea Park
              Marathon and raised £275 for The Alzheimer&apos;s Society!
            </p>
          </section>
          {/* <section>{runs ? <RunningDataView /> : <div>{errorMsg}</div>}</section> */}
        </article>
      </main>
    </>
  )
